...
setup(windows = [
        {
            "script": "pygihashlibgui.py",
            "icon_resources": [(1, "com.github.yucefsourani.PygiHashLibGui.ico")]
        }
    ],options={ 
    'py2exe': { 
        'includes' : ['gi' ], 
...
for dll in tmp_dlls: 
    ...
    #os.remove(dll) 
for icon in ["com.github.yucefsourani.PygiHashLibGui.png","com.github.yucefsourani.PygiHashLibGui.ico"]:
